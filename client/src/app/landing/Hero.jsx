    ...
    return (
        <section className="bg-white dark:bg-gray-900 flex flex-col-reverse items-center justify-between md:flex-row py-8 p-4 w-full">
            <div className=" px-4 mx-auto max-w-screen-xl *:text-start lg:pl-12">
                ...
                <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl my-4 dark:text-gray-400">
                ...
                <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row justify-center sm:justify-start sm:space-y-0 sm:space-x-4">
                    <Link to="/apply" className="inline-flex sm:ml-4 justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"> اخبرنا عنك </Link>
