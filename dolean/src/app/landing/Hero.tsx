...
let Hero = () => {
    ...
    const islogin = headersList.get('authorization') 
    return (
        <section className="bg-white ddark:bg-gray-900 flex flex-col-reverse items-center justify-between md:flex-row py-8 p-4 w-full">
            <div className=" px-4 mx-auto max-w-screen-xl *:text-start lg:pl-12">
                ...
                <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row justify-center sm:justify-start sm:space-y-0 sm:space-x-4">
                    <Link href="/apply" className="inline-flex sm:ml-4 justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 ddark:focus:ring-primary-900"> اخبرنا عنك </Link>
                    {!islogin && <Link href="/auth?route=login" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center bg-white border border-primary-700 rounded-lg text-primary-700 hover:text-primary-800 focus:ring-4 focus:ring-primary-300 ddark:focus:ring-primary-900"> تسجيل دخول </Link>}
                </div>
            </div>
