...
const CourseItem = ({ imageUrl, title, location, price }) => {
    return (
        <div className="flex items-center gap-4 bg-white px-4 min-h-[72px] py-2 justify-between rounded-lg hover:bg-slate-100 group">
