...
const PricingCard = ({ title, description, price, list = [], to, textLink }) => (
    <div className="flex flex-col p-6 mx-auto max-w-lg- text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white max-w-[400px]">
        ...
        <div className="flex justify-center items-baseline my-8">
            ...
            <span className="text-gray-500 dark:text-gray-400 "> /شهري</span>
        </div>
        ...
        <Link to={to} className={`${typeof price == "string" ? "bg-white text-primary-600" : "text-white bg-primary-600"}   focus:ring-4 focus:ring-primary-200 font-medium rounded-lg border  border-primary-600  text-sm px-5 py-2.5 text-center dark:text-white dark:focus:ring-primary-900`}>{textLink}</Link>
    </div>
);
    ...
    <section className="bg-white dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div className="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">التسعيرة</h2>
