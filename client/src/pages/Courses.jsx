...
function Card() {
    return (
        <div class="bg-card flex items-center justify-between m-4 rounded-lg space-x-4 text-card-foreground"        >
            <div>
                ...
                <div class="inline-flex w-fit items-center whitespace-nowrap rounded-full border px-2.5 py-0.5 text-xs font-semibold bg-slate-100 transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80">
                    اونلاين
                </div>
            </div>
            <img
